  ...
  return (
    <div className="px-6 py-16 md:px-12 lg:px-20">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="relative overflow-hidden border-2 border-dashed border-[#2C2C2C]/10 bg-[#2C2C2C] p-8 md:p-12">
          ...
          {/* Center hub */}
          <div className="mx-auto mb-4 flex w-fit items-center gap-3 border-2 border-[#D4A843]/40 bg-[#D4A843]/10 px-8 py-4">
